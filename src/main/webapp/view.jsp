...
<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 dao.countingSc(Integer.parseInt(id));
...
<head>
 ...
 <!--   <script src="https://kit.fontawesome.com/c47106c6a7.js" crossorigin="anonymous"></script>-->
    ...
    <style>
        table { width:1000px;  text-align:center; margin: auto; }
        th    { width:150px; background-color:gray; margin: auto; font-size: 30px }
        td    { text-align:left; border:1px solid gray; margin: auto;font-size:30px }
    </style>
...
<br>
<input type="button" value="목록보기" onclick="location.href='comyu.jsp'">
<input type="button" value="수정"
       onclick="location.href='write3.jsp?id=<%=dto.getId() %>'">
